...
\- Collecter et centraliser les logs cloud via \*\*CloudTrail\*\* et \*\*VPC Flow Logs\*\*.  

\- Expérimenter la détection des menaces et l’ingénierie des règles de sécurité (Blue Team).  

\- Automatiser l’infrastructure avec \*\*Terraform\*\* et préparer le terrain pour la gestion de configuration avec \*\*Ansible\*\*.  
...
\- EC2 deployed (Amazon Linux 2023)

\- Security Group hardened (SSH restricted to personal IP)



Region: us-west-1 (California North)
...
\- Cloud-native logging (CloudTrail, VPC Flow Logs)
